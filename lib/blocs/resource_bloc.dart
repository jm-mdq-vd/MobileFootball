...
class ResourceBloc<Resource> extends Bloc<ResourceEvent<Resource>, ResourceState<Resource>> {
  ...
  void _mapEventToState(ResourceEvent<Resource> event, Emitter<ResourceState<Resource>> emit) async {
    emit(ResourceState(status: ResourceStatus.loading));
